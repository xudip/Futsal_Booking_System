...
import com.example.sugaste.futsal_booking_system.fragments.CustomerMainScreen;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserLoginTask(enteredEmail, enteredPassword);
...
*/
            ...
            for (String credential : DUMMY_CREDENTIALS) {
                ...
                if (pieces[0].equals(enteredEmail)) {
                    // Account exists, return true if the password matches.
                    return pieces[1].equals(enteredPassword);
                }
            }
